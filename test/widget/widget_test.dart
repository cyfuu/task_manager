...
void main() {
  ...
  group('TaskTile - Rendering', () {
    ...
    testWidgets('returns true when TaskTile displays the correct task title', (
      ...
      await tester.pumpWidget(
        buildTaskTile(task: task, onToggle: () {}, onDelete: () {}),
      );

      expect(find.text(task.title), findsOneWidget);
    });
    testWidgets(
      'returns true when TaskTile displays the correct priority label',
  ...
  group('TaskTile - Delete Interaction', () {
    ...
    testWidgets(
      'returns true when onDelete is called when tapping delete button',
      (WidgetTester tester) async {
        bool deleted = false;
        await tester.pumpWidget(
          buildTaskTile(
  ...
  group('TaskTile - Completed State UI', () {
    ...
    testWidgets(
      'returns true when LineThrough is visible during isCompleted state',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildTaskTile(task: task, onToggle: () {}, onDelete: () {}),
        );
    ...
    testWidgets(
      'returns true when LineThrough is invisible during incomplete state',
      (WidgetTester tester) async {
  ...
  group('TaskTile - Key Assertions', () {
    ...
    testWidgets(
      'returns true when Checkbox and Delete button keys are correct',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildTaskTile(task: task, onToggle: () {}, onDelete: () {}),
        );
